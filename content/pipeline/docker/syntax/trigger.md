...
The cron trigger limits pipeline execution based on the name of the cron job that triggered the pipeline. This only applies to cron events.  _Note that you must [create cron jobs](/cron/) before they can be reference in your yaml_.
